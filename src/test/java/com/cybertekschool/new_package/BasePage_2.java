...
public class BasePage_2 {
	...
	public void commonThings(ArrayList<String> messages, String whichOne, ArrayList<String> excelPagesList, String sheetAdded1, String sheetAdded2) {
						...
						for (int j = 0; j < dataList.size(); j++) {
							...
							if (dataList.get(j) == 0 && !allURLsList.get(j).equals("null")) {
								...
								if (whichOne.equals("recordings")) {
									...
									quizAssignPage(driver, All_Students_List, studentIndexNo, studentFolderString, taskCount);
								}
	...
	public void quizAssignPage(WebDriver driver, ArrayList<String> All_Students_List, int studentIndexNo, String studentFolderString, int taskCount) throws InterruptedException, IOException {

		WebElement quizName = null;
		quizName:
		for (int i = 0; i < 3; i++) {
			try {
				quizName = driver.findElement(By.xpath("//*[@id='quiz_title']"));
				break quizName;
			}catch (Exception e){
				Thread.sleep(1000);
			}
